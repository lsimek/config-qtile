...
keys = [
    ...
    Key([mod], "d", lazy.spawn("dmenu_run -i -nb '#222222' -nf '#e0c6ff' -sb '#c2ff79' -sf '#222222' -fn 'HackNerdFontMono:bold:pixelsize=14'")),
    ...
    Key([mod, "shift"], "d", lazy.spawn('nwggrid -p -o 0.6')),
